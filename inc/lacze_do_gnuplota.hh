...
class LaczeDoGNUPlota {
 ...
 public:
   ...
   * \param[in]  kat_x - wartość kąta rotacji. Jego wartość podawana 
   *                 jest w stopniach.
   */
   ...
   * punktu obserwacji renderowanego rysunku.
   * \param[in]  kat_z - wartość kąta rotacji. Jego wartość podawana 
   *                 jest w stopniach.
   */
   ...
   * Umożliwia to zmianę
   * punktu obserwacji renderowanego rysunku.
   * \param[in]  kat_x - wartość kąta rotacji względem osi \e OX. 
   *                 Jego wartość podawana 
   *                 jest w stopniach.
   * \param[in]  kat_z - wartość kąta rotacji względem osi \e OZ. 
   *                 Jego wartość podawana 
   *                 jest w stopniach.
   */
